...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8208492710:AAGDXsgZM0bV2hPzv2IXo-BH6gI9vsU13ew")
...
FILE_CHANNEL = int(os.environ.get("FILE_CHANNEL", "-1002561804283"))
FILE_BOT_USERNAME = os.environ.get("FILE_BOT_USERNAME", "DominosXBot")
